...
public class BlowFishFilter implements Filter {
...
//		}
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if (checkRequestURLInFilterList(httpRequest)) {
			BlowFishRequestWrapper  blowFishRequestWrapper = new BlowFishRequestWrapper((HttpServletRequest) httpRequest);
			chain.doFilter(blowFishRequestWrapper, httpResponse);
		}else{
