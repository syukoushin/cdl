...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #eeeeee;">
					...
					<div class="create_right fr">
						...
						<form id="myForm" action="${base}/admin/WordOrder_ajaxAdd.do" method="post" enctype="multipart/form-data">
							<table border="0" cellspacing="" cellpadding=""><tbody>
								<tr>
									<td class="span_tdl siyuannormal">号牌号码：</td>
								...
								<tr id="deptTr"><td class="span_tdl siyuannormal">品牌型号：</td>
									<td  class="span_tdr siyuannormal">
									${entity.bandNo?if_exists}
									</td>
								</tr>
								<tr id="deptTr"><td class="span_tdl siyuannormal">车辆识别代码：</td>
									<td  class="span_tdr siyuannormal">
									${entity.carNo?if_exists}
									</td>
								</tr>
								<tr id="deptTr"><td class="span_tdl siyuannormal">发动机号码：</td>
									<td  class="span_tdr siyuannormal">
									${entity.enginNo?if_exists}
									</td>
								</tr>
		...
		<div id="showBigImg" style="display:none" class="mask_content" style="top:30%">
			...
			<div style="width:600px;height:300px;text-align:center" id="bigImgDiv">
	...
	<script>
		...
		function goList(){
			window.location ="${base}/manage/Manage_toList.do";
		}
		function bigImg(obj){
