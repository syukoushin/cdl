...
<ul>
	...
	<#if Session.CURRENT_USER.jobLevel =='1'>
        <li <#if 'admin' == Session.CURRENT_MENU> class="select"</#if>><a href="javascript:void(0);" onclick="goAdmin()" class="siyuannormal" style="font-size:16px;"><i class="link_i2"><img src="/cdl/images/cms/iconfont_5.png"></i>管理员</a></li>
	</#if>
</ul>
</#macro>