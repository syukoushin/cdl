...
(function($) {
				...
				.droppable(
						{
							...
							onDragOver : function(e, _1a) {
								...
								$(_1a).draggable("proxy").removeClass(
							...
							onDragLeave : function(e, _1d) {
								$(_1d).draggable("proxy").removeClass(
							...
							onDrop : function(e, _1e) {
								...
								if ($(this).hasClass("tree-node-append")) {
									...
									_20 = _23;
									_21 = $(this).hasClass("tree-node-top") ? "top"
											: "bottom";
								}
								setTimeout(function() {
									_20(_1e, _1f, _21);
	...
	function _47(_48, ul, _49, _4a) {
		...
		var _4c = [];
		var _4d = $(ul).prev("div.tree-node").find(
	...
	function _5f(_60, _61, _62) {
		...
		if (ul.length) {
			...
			_56(_60, _65[0], {
				id : _64.id,
				attributes : _64.attributes//增加自定义参数
			}, function() {
				if (_63.animate) {
	...
	function _9a(_9b, _9c) {
		...
		if (ul.children("li").length == 0) {
			var _9e = ul.prev();
			_9e.find(".tree-icon").removeClass("tree-folder").addClass(
					"tree-file");
	...
	function _36(_ab, _ac) {
		...
		if (!_42(_ab, _ac)) {
			_ad.state = $(_ac).find(".tree-hit").hasClass("tree-expanded") ? "open"
					: "closed";
		}
		return _ad;
	}
